...
(function(Opal) {
  ...
  Opal.add_stubs(['$require', '$new', '$add_text', '$eset!', '$position', '$enabled_advanced_timing!', '$delta_time', '$game_size', '$each', '$velocity', '$sprite', '$size', '$eadd!', '$*', '$add!', '$+', '$y', '$>', '$y=', '$-', '$-@', '$<', '$x', '$x=', '$key_down?', '$times', '$velocity=', '$[]', '$rand', '$sprite=', '$add_sprite', '$<<', '$bring_to_top', '$text=', '$average_fps']);
