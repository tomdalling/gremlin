...
(function(Opal) {
  ...
  (function($base, $super) {
    function $Bunnymark(){};
    var self = $Bunnymark = $klass($base, $super, 'Bunnymark', $Bunnymark);

    var def = self.$$proto, $scope = self.$$scope;

    def.fps = def.bunnies = nil;
    Opal.cdecl($scope, 'GRAVITY', 200);

    Opal.cdecl($scope, 'Bunny', $scope.get('Struct').$new("sprite", "velocity"));

    def.$assets = function() {
      var self = this;

      return $hash2(["image"], {"image": ["bunny"]});
    };

    def.$create = function() {
      var self = this;

      self['$enabled_advanced_timing!']();
      self.bunnies = [];
      self.fps = self.$add_text("", $hash2(["fill"], {"fill": "white"}));
      return self.fps.$position()['$eset!'](20, 20);
    };

    return (def.$update = function() {
      var $a, $b, TMP_1, $c, TMP_2, $d, self = this, dt = nil, gs = nil;

      dt = self.$delta_time();
      gs = self.$canvas_size();
      ($a = ($b = self.bunnies).$each, $a.$$p = (TMP_1 = function(t){var self = TMP_1.$$s || this, $a, $b, vel = nil, pos = nil, size = nil, max_y = nil, max_x = nil;
if (t == null) t = nil;
      vel = t.$velocity();
        pos = t.$sprite().$position();
        size = t.$sprite().$size();
        vel['$eadd!'](0, dt['$*']($scope.get('GRAVITY')));
        pos['$add!'](dt['$*'](vel));
        max_y = pos.$y()['$+'](size.$y());
        if (max_y['$>'](gs.$y())) {
          (($a = [gs.$y()['$-']((max_y['$-'](gs.$y())))['$-'](size.$y())]), $b = pos, $b['$y='].apply($b, $a), $a[$a.length-1]);
          (($a = [(vel.$y())['$-@']()]), $b = vel, $b['$y='].apply($b, $a), $a[$a.length-1]);};
        if (pos.$x()['$<'](0)) {
          (($a = [(pos.$x())['$-@']()]), $b = pos, $b['$x='].apply($b, $a), $a[$a.length-1]);
          (($a = [(vel.$x())['$-@']()]), $b = vel, $b['$x='].apply($b, $a), $a[$a.length-1]);};
        max_x = pos.$x()['$+'](size.$x());
        if (max_x['$>'](gs.$x())) {
          (($a = [gs.$x()['$-'](size.$x())['$-']((max_x['$-'](gs.$x())))]), $b = pos, $b['$x='].apply($b, $a), $a[$a.length-1]);
          return (($a = [(vel.$x())['$-@']()]), $b = vel, $b['$x='].apply($b, $a), $a[$a.length-1]);
          } else {
          return nil
        };}, TMP_1.$$s = self, TMP_1), $a).call($b);
      if ((($a = ((($c = self['$key_down?']((((($scope.get('Gremlin')).$$scope.get('Keyboard'))).$$scope.get('KEY_SPACEBAR')))) !== false && $c !== nil) ? $c : self['$pointer_down?']())) !== nil && (!$a.$$is_boolean || $a == true))) {
        ...
        t = $scope.get('Bunny').$new();
          (($a = [(($scope.get('Gremlin')).$$scope.get('Vec2'))['$[]'](self.$rand($range(-200, 200, false)), 0)]), $b = t, $b['$velocity='].apply($b, $a), $a[$a.length-1]);
          (($a = [self.$add_sprite("bunny")]), $b = t, $b['$sprite='].apply($b, $a), $a[$a.length-1]);
          (($a = [self.$rand(800)]), $b = t.$sprite().$position(), $b['$x='].apply($b, $a), $a[$a.length-1]);
          return self.bunnies['$<<'](t);}, TMP_2.$$s = self, TMP_2), $a).call($c);
        self.fps.$bring_to_top();};
      return (($a = ["FPS: " + (self.$average_fps()) + ", BUNNIES: " + (self.bunnies.$size())]), $d = self.fps, $d['$text='].apply($d, $a), $a[$a.length-1]);
    }, nil) && 'update';
  })(self, (($scope.get('Gremlin')).$$scope.get('Game')));
  return $scope.get('Gremlin').$run_game($scope.get('Bunnymark'), $hash2(["width", "height", "smooth_sprites"], {"width": 800, "height": 300, "smooth_sprites": false}));
})(Opal);
