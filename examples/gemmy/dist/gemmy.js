...
/* Generated by Opal 0.7.1 */
Opal.modules["gremlin/asset_pack"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $klass = Opal.klass, $hash2 = Opal.hash2;

  Opal.add_stubs(['$flat_map', '$map', '$Array', '$fetch', '$merge!', '$send', '$[]', '$[]=', '$delete', '$to_n', '$+', '$raise', '$merge']);
  return (function($base) {
    var self = $module($base, 'Gremlin');
    ...
    (function($base, $super) {
      function $AssetPack(){};
      var self = $AssetPack = $klass($base, $super, 'AssetPack', $AssetPack);

      var def = self.$$proto, $scope = self.$$scope;

      def.assets = def.animations = nil;
      def.$initialize = function(asset_manifest) {
        var $a, $b, TMP_1, self = this;

        self.animations = $hash2([], {});
        return self.assets = ($a = ($b = asset_manifest).$flat_map, $a.$$p = (TMP_1 = function(type, asset_list){var self = TMP_1.$$s || this, $a, $b, TMP_2;
if (type == null) type = nil;if (asset_list == null) asset_list = nil;
        return ($a = ($b = asset_list).$map, $a.$$p = (TMP_2 = function(asset){var self = TMP_2.$$s || this, $a, key = nil, options = nil, hash = nil;
            if (self.animations == null) self.animations = nil;
if (asset == null) asset = nil;
          $a = Opal.to_ary(self.$Array(asset)), key = ($a[0] == null ? nil : $a[0]), options = ($a[1] == null ? nil : $a[1]);
            hash = $hash2(["key", "type"], {"key": key, "type": $scope.get('IRREGULAR_TYPES').$fetch(type, type)});
            hash['$merge!'](self.$send("" + (type) + "_options", key, ((($a = options) !== false && $a !== nil) ? $a : $hash2([], {}))));
            if ((($a = hash['$[]']("_animations")) !== nil && (!$a.$$is_boolean || $a == true))) {
              self.animations['$[]='](key, hash.$delete("_animations"))};
            return hash;}, TMP_2.$$s = self, TMP_2), $a).call($b)}, TMP_1.$$s = self, TMP_1), $a).call($b);
      };

      def.$phaser_pack_object = function() {
        var self = this;

        return $hash2(["assets", "meta"], {"assets": self.assets, "meta": $hash2(["generated", "version", "app", "url"], {"generated": Date.now(), "version": "1.0", "app": "Gremlin", "url": "https://github.com/tomdalling/gremlin"})}).$to_n();
      };

      def.$animations = function() {
        var self = this;

        return self.animations;
      };

      def.$image_options = function(key, opts) {
        var self = this;

        return $hash2(["url", "overwrite"], {"url": "asset/image/" + (opts.$fetch("path", key['$+'](".png"))), "overwrite": opts.$fetch("overwrite", false)});
      };

      def.$text_options = function(key, opts) {
        var self = this;

        return $hash2(["url", "overwrite"], {"url": "asset/text/" + (opts.$fetch("path", key['$+'](".txt"))), "overwrite": opts.$fetch("overwrite", false)});
      };

      def.$json_options = function(key, opts) {
        var self = this;

        return $hash2(["url", "overwrite"], {"url": "asset/json/" + (opts.$fetch("path", key['$+'](".json"))), "overwrite": opts.$fetch("overwrite", false)});
      };

      def.$script_options = function(key, opts) {
        var self = this;

        return $hash2(["url"], {"url": "asset/script/" + (opts.$fetch("path", key['$+'](".js")))});
      };

      def.$binary_options = function(key, opts) {
        var self = this;

        return $hash2(["url"], {"url": "asset/binary/" + (opts.$fetch("path", key['$+'](".bin")))});
      };

      def.$spritesheet_options = function(key, opts) {
        var self = this;

        return $hash2(["url", "frameWidth", "frameHeight", "frameMax", "margin", "spacing"], {"url": "asset/spritesheet/" + (opts.$fetch("path", key['$+'](".png"))), "frameWidth": opts.$fetch("frame_size")['$[]'](0), "frameHeight": opts.$fetch("frame_size")['$[]'](1), "frameMax": opts.$fetch("frame_max", -1), "margin": opts.$fetch("margin", 0), "spacing": opts.$fetch("spacing", 0)});
      };

      def.$audio_options = function(key, opts) {
        var $a, $b, TMP_3, self = this, paths = nil;

        paths = self.$Array(((($a = ((($b = opts['$[]']("path")) !== false && $b !== nil) ? $b : opts['$[]']("paths"))) !== false && $a !== nil) ? $a : key['$+'](".mp3")));
        return $hash2(["urls", "autoDecode"], {"urls": ($a = ($b = paths).$map, $a.$$p = (TMP_3 = function(p){var self = TMP_3.$$s || this;
if (p == null) p = nil;
        return "asset/audio/" + (p)}, TMP_3.$$s = self, TMP_3), $a).call($b), "autoDecode": opts.$fetch("auto_decode", true)});
      };

      def.$tilemap_options = function(key, opts) {
        var self = this;
      ...
      def.$physics_options = function(key, opts) {
        var self = this;
      ...
      def.$bitmap_font_options = function(key, opts) {
        var self = this;

        return self.$raise($scope.get('NotImplementedError'), "Bitmap fonts are not implemented yet");
      };

      def.$atlas_options = function(key, opts) {
        var $a, $b, TMP_4, self = this;

        return $hash2(["atlasURL", "textureURL", "atlasData", "format", "_animations"], {"atlasURL": "asset/atlas/" + (opts.$fetch("data_path", key['$+'](".json"))), "textureURL": "asset/atlas/" + (opts.$fetch("texture_path", key['$+'](".png"))), "atlasData": opts.$fetch("data", nil), "format": opts.$fetch("format", "TEXTURE_ATLAS_JSON_ARRAY"), "_animations": ($a = ($b = opts.$fetch("animations", [$scope.get('ANIM_DEFAULTS')])).$map, $a.$$p = (TMP_4 = function(a){var self = TMP_4.$$s || this;
if (a == null) a = nil;
        return $scope.get('ANIM_DEFAULTS').$merge(a)}, TMP_4.$$s = self, TMP_4), $a).call($b)});
      };

      Opal.cdecl($scope, 'IRREGULAR_TYPES', $hash2(["bitmap_font"], {"bitmap_font": "bitmapFont"}));

      return Opal.cdecl($scope, 'ANIM_DEFAULTS', $hash2(["name", "frames", "fps", "loop"], {"name": "default", "frames": nil, "fps": 5, "loop": true}));
    })(self, null)
  })(self)
};
...
Opal.modules["gremlin/game"] = function(Opal) {
  ...
  Opal.add_stubs(['$raise', '$_apply_sprite_animations', '$to_n', '$down?', '$any?', '$to_proc', '$[]', '$protected', '$attr_accessor', '$init', '$new', '$assets', '$phaser_pack_object', '$add_text', '$eset!', '$position', '$scale', '$*', '$destroy!', '$create', '$render', '$update', '$paused', '$pause_update', '$resize', '$shutdown', '$private', '$key_down', '$key_up', '$pointer_down', '$set!', '$position_up', '$pointer_up', '$each', '$fetch', '$animations']);
  return (function($base) {
    var self = $module($base, 'Gremlin');
    ...
    (function($base, $super) {
      ...
      def.smooth_sprites = def.pack = def._loading_text = def._loading_bar = nil;
      def.$init = function() {
        var self = this;
      ...
      def.$add_sprite = function(key) {
        ...
        self.$_apply_sprite_animations(key, s);
        return s;
      };
      ...
      def.$phaser_preload = function() {
        ...
        self.pack = (($scope.get('Gremlin')).$$scope.get('AssetPack')).$new(self.$assets());
        return self.load.pack("assets", null, self.pack.$phaser_pack_object());
      };
      ...
      def.$_apply_sprite_animations = function(key, sprite) {
        var $a, $b, TMP_1, self = this;

        return ($a = ($b = self.pack.$animations().$fetch(key, [])).$each, $a.$$p = (TMP_1 = function(a){var self = TMP_1.$$s || this;
if (a == null) a = nil;
        return sprite.animations.add(a['$[]']("name"), a['$[]']("frames").$to_n(), a['$[]']("fps"), a['$[]']("loop"));}, TMP_1.$$s = self, TMP_1), $a).call($b);
      };
...
if (opal_key == null) opal_key = nil;if (js_key == null) js_key = nil;
      ...
      return Opal.cdecl($scope, 'PATCHED_METHODS', $hash2(["phaser_init", "phaser_preload", "phaser_load_render", "phaser_load_update", "phaser_create", "phaser_update", "phaser_render", "phaser_paused", "phaser_pause_update", "phaser_resize", "phaser_shutdown"], {"phaser_init": "init", "phaser_preload": "preload", "phaser_load_render": "loadRender", "phaser_load_update": "loadUpdate", "phaser_create": "create", "phaser_update": "update", "phaser_render": "render", "phaser_paused": "paused", "phaser_pause_update": "pauseUpdate", "phaser_resize": "resize", "phaser_shutdown": "shutdown"}));
    })(self, Phaser.State)
  })(self)
};
...
Opal.modules["gremlin/sprite"] = function(Opal) {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      return (def.$play_animation = function(name) {
        var self = this;

        return self.animations.play(name);
      }, nil) && 'play_animation';
    })(self, Phaser.Sprite)
  })(self)
};
...
Opal.modules["gremlin"] = function(Opal) {
  ...
  self.$require("gremlin/asset_pack");
...
(function(Opal) {
  Opal.dynamic_require_severity = "error";
  var $a, $b, TMP_14, $c, TMP_15, $d, TMP_16, $e, TMP_17, $f, TMP_18, $g, TMP_19, $h, TMP_20, $i, $j, TMP_26, self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $hash2 = Opal.hash2, $klass = Opal.klass, $range = Opal.range, $module = Opal.module, g = nil;

  Opal.add_stubs(['$require', '$include', '$/', '$*', '$attr_accessor', '$new', '$+', '$map', '$rjust', '$to_s', '$transition_to_scene', '$maybe_transition', '$key_down', '$key_up', '$pointer_down', '$pointer_up', '$update', '$draw', '$private', '$!', '$native?', '$is_a?', '$shutdown', '$game=', '$startup', '$call', '$const_get', '$class', '$each', '$[]=', '$merge!', '$class_exec', '$to_proc', '$keys', '$const_set', '$[]', '$reopen', '$fetch', '$each_char', '$chomp', '$lines', '$each_with_index', '$rows', '$size', '$first', '$==', '$type', '$cell_at', '$>', '$<', '$pos', '$player', '$distance_to', '$x', '$<<', '$y', '$alive', '$orientation=', '$orientation_for_movement', '$dup', '$can_move_to?', '$level', '$to_a', '$select', '$entities', '$play_sound', '$game', '$get_text', '$from_text', '$entities=', '$each_cell', '$===', '$player=', '$goal=', '$type=', '$image_frame=', '$rand', '$sample', '$sprite=', '$add_sprite', '$image_frame', '$eset!', '$position', '$sprite', '$pivot', '$width', '$height', '$scale', '$rotation=', '$orientation', '$goal', '$image_key', '$play_animation', '$bring_to_top', '$reverse', '$sort_by', '$index', '$add_text', '$movement_sets', '$move_player', '$next_level', '$swipe_direction', '$-', '$position_up', '$position_down', '$length', '$abs', '$%', '$raise', '$try_move', '$just_teleported=', '$ai', '$think', '$apply_ai', '$movements', '$moves', '$spawns', '$alive=', '$kills', '$>=', '$row_count', '$column_count', '$find', '$pushable', '$eeql?', '$-@', '$update_next_movement', '$pos_fraction', '$any?', '$deadly', '$teleport_pair', '$just_teleported', '$pos=', '$select!', '$destroy!', '$<=', '$progress', '$progress=', '$delta_time', '$lerp_to', '$from', '$set!', '$entity', '$shift', '$canvas_size', '$run_game']);
...
if (i == null) i = nil;
      return "floor_0" + (i)}, TMP_2.$$s = self, TMP_2), $a).call($c)), "atlas": ["player", ["goal", $hash2(["animations"], {"animations": [$hash2(["fps"], {"fps": 5})]})], "chaser", "shooter", "teleporter"], "text": ($a = ($d = ($range(1, $scope.get('NUM_LEVELS'), false))).$map, $a.$$p = (TMP_3 = function(i){var self = TMP_3.$$s || this;
if (i == null) i = nil;
...
if (k == null) k = nil;if (v == null) v = nil;
  ...
  Opal.cdecl($scope, 'Entity', ($a = ($b = $scope.get('DefStruct')).$new, $a.$$p = (TMP_14 = function(){var self = TMP_14.$$s || this;

  return $hash2(["sprite", "pos", "pos_fraction", "ai", "color", "tint", "image_key", "fps", "alive", "orientation", "pushable", "teleport_pair", "just_teleported", "deadly"], {"sprite": nil, "pos": $scope.get('Vec2')['$[]'](0, 0), "pos_fraction": $scope.get('Vec2')['$[]'](0, 0), "ai": nil, "color": "white", "tint": "white", "image_key": nil, "fps": 3, "alive": true, "orientation": "north", "pushable": false, "teleport_pair": nil, "just_teleported": false, "deadly": true})}, TMP_14.$$s = self, TMP_14), $a).call($b));
  Opal.cdecl($scope, 'Movement', ($a = ($c = $scope.get('DefStruct')).$new, $a.$$p = (TMP_15 = function(){var self = TMP_15.$$s || this;

  return $hash2(["entity", "from"], {"entity": nil, "from": $scope.get('Vec2')['$[]'](0, 0)})}, TMP_15.$$s = self, TMP_15), $a).call($c));
  Opal.cdecl($scope, 'MovementSet', ($a = ($d = $scope.get('DefStruct')).$new, $a.$$p = (TMP_16 = function(){var self = TMP_16.$$s || this;

  return $hash2(["movements", "progress"], {"movements": [], "progress": 0.0})}, TMP_16.$$s = self, TMP_16), $a).call($d));
  Opal.cdecl($scope, 'GameState', ($a = ($e = $scope.get('DefStruct')).$new, $a.$$p = (TMP_17 = function(){var self = TMP_17.$$s || this;

  return $hash2(["level", "player", "goal", "entities", "movement_sets"], {"level": nil, "player": nil, "goal": nil, "entities": [], "movement_sets": []})}, TMP_17.$$s = self, TMP_17), $a).call($e));
  Opal.cdecl($scope, 'AiResults', ($a = ($f = $scope.get('DefStruct')).$new, $a.$$p = (TMP_18 = function(){var self = TMP_18.$$s || this;

  return $hash2(["moves", "spawns", "kills"], {"moves": [], "spawns": [], "kills": []})}, TMP_18.$$s = self, TMP_18), $a).call($f));
  Opal.cdecl($scope, 'Cell', ($a = ($g = $scope.get('DefStruct')).$new, $a.$$p = (TMP_19 = function(){var self = TMP_19.$$s || this;

  return $hash2(["type", "image_frame", "orientation", "sprite"], {"type": "none", "image_frame": 0, "orientation": "north", "sprite": nil})}, TMP_19.$$s = self, TMP_19), $a).call($g));
  Opal.cdecl($scope, 'Level', ($a = ($h = ($i = ($j = $scope.get('DefStruct')).$new, $i.$$p = (TMP_26 = function(){var self = TMP_26.$$s || this;

  return $hash2(["rows", "entities"], {"rows": [], "entities": []})}, TMP_26.$$s = self, TMP_26), $i).call($j)).$reopen, $a.$$p = (TMP_20 = function(){var self = TMP_20.$$s || this, TMP_25;

  Opal.defs(self, '$from_text', function(file_string) {
      var $a, $b, TMP_21, self = this, rows = nil;

      rows = ($a = ($b = file_string.$lines()).$map, $a.$$p = (TMP_21 = function(line){var self = TMP_21.$$s || this, $a, $b, TMP_22;
if (line == null) line = nil;
      return ($a = ($b = line.$chomp("\n").$each_char()).$map, $a.$$p = (TMP_22 = function(char$){var self = TMP_22.$$s || this;
if (char$ == null) char$ = nil;
        return $scope.get('Cell').$new($hash2(["type"], {"type": $scope.get('CELL_TYPES_BY_CHAR').$fetch(char$)}))}, TMP_22.$$s = self, TMP_22), $a).call($b)}, TMP_21.$$s = self, TMP_21), $a).call($b);
      return self.$new($hash2(["rows"], {"rows": rows}));
    });
    Opal.defn(self, '$each_cell', TMP_25 = function() {
      var $a, $b, TMP_23, self = this, $iter = TMP_25.$$p, $yield = $iter || nil;

      TMP_25.$$p = null;
      return ($a = ($b = self.$rows()).$each_with_index, $a.$$p = (TMP_23 = function(row, row_idx){var self = TMP_23.$$s || this, $a, $b, TMP_24;
if (row == null) row = nil;if (row_idx == null) row_idx = nil;
      return ($a = ($b = row).$each_with_index, $a.$$p = (TMP_24 = function(cell, col_idx){var self = TMP_24.$$s || this, $a;
if (cell == null) cell = nil;if (col_idx == null) col_idx = nil;
        return $a = Opal.yieldX($yield, [$scope.get('Vec2')['$[]'](col_idx, row_idx), cell]), $a === $breaker ? $a : $a}, TMP_24.$$s = self, TMP_24), $a).call($b)}, TMP_23.$$s = self, TMP_23), $a).call($b);
    });
    ...
    return (Opal.defn(self, '$can_move_to?', function(x, y) {
      ...
      return self.$cell_at(x, y).$type()['$==']("floor");
    }), nil) && 'can_move_to?';}, TMP_20.$$s = self, TMP_20), $a).call($h));
  ...
  (function($base, $super) {
    ...
    return (def.$think = function(shooter, game) {
      ...
      if (projectile_vel !== false && projectile_vel !== nil) {
        ...
        self.projectile = $scope.get('Entity').$new($hash2(["image_key", "pos", "ai"], {"image_key": "bullet", "pos": shooter.$pos().$dup(), "ai": $scope.get('ProjectileAi').$new(projectile_vel)}));
  ...
  (function($base, $super) {
    ...
    return (def.$think = function(projectile, game) {
      var $a, $b, $c, TMP_27, self = this, new_pos = nil, kills = nil;

      new_pos = projectile.$pos()['$+'](self.velocity);
      if ((($a = ($b = game.$level())['$can_move_to?'].apply($b, [].concat(new_pos.$to_a()))) !== nil && (!$a.$$is_boolean || $a == true))) {
        kills = ($a = ($c = game.$entities()).$select, $a.$$p = (TMP_27 = function(e){var self = TMP_27.$$s || this;
if (e == null) e = nil;
        return e.$pos()['$=='](new_pos)}, TMP_27.$$s = self, TMP_27), $a).call($c);
        if (kills.$size()['$>'](0)) {
          kills['$<<'](projectile)};
  ...
  (function($base, $super) {
    ...
    Opal.cdecl($scope, 'ENTITY_SORT_ORDER', ["dirtball", "chaser", "player"]);
    ...
    def.$startup = function() {
      var $a, $b, TMP_28, $c, TMP_29, $d, TMP_30, $e, TMP_31, $f, $g, TMP_32, self = this, level_text = nil, all_entities = nil;
      ...
      ($a = ($b = self.state.$level()).$each_cell, $a.$$p = (TMP_28 = function(pos, cell){var self = TMP_28.$$s || this, $a, $b, found_entity = nil, $case = nil;
        if (self.state == null) self.state = nil;
if (pos == null) pos = nil;if (cell == null) cell = nil;
      found_entity = (function() {$case = cell.$type();if ("player"['$===']($case)) {return (($a = [$scope.get('Entity').$new($hash2(["pos", "image_key"], {"pos": pos.$dup(), "image_key": "player"}))]), $b = self.state, $b['$player='].apply($b, $a), $a[$a.length-1])}else if ("enemy"['$===']($case)) {return self.state.$entities()['$<<']($scope.get('Entity').$new($hash2(["pos", "image_key", "ai"], {"pos": pos.$dup(), "image_key": "chaser", "ai": $scope.get('ChaserAi').$new()})))}else if ("shooter"['$===']($case)) {return self.state.$entities()['$<<']($scope.get('Entity').$new($hash2(["pos", "image_key", "ai"], {"pos": pos.$dup(), "image_key": "shooter", "ai": $scope.get('ShooterAi').$new()})))}else if ("goal"['$===']($case)) {return (($a = [$scope.get('Entity').$new($hash2(["pos", "image_key", "fps"], {"pos": pos.$dup(), "image_key": "goal", "fps": 5}))]), $b = self.state, $b['$goal='].apply($b, $a), $a[$a.length-1])}else if ("dirtball"['$===']($case)) {return self.state.$entities()['$<<']($scope.get('Entity').$new($hash2(["pos", "image_key", "pushable"], {"pos": pos.$dup(), "image_key": "dirtball", "pushable": true})))}else if ("teleporter"['$===']($case)) {return self.state.$entities()['$<<']($scope.get('Entity').$new($hash2(["pos", "image_key", "teleport_pair", "deadly"], {"pos": pos.$dup(), "image_key": "teleporter", "teleport_pair": 1, "deadly": false})))}else {return false}})();
        if (found_entity !== false && found_entity !== nil) {
          return (($a = ["floor"]), $b = cell, $b['$type='].apply($b, $a), $a[$a.length-1])
          } else {
          return nil
        };}, TMP_28.$$s = self, TMP_28), $a).call($b);
      ($a = ($c = self.state.$level()).$each_cell, $a.$$p = (TMP_29 = function(cell_pos, cell){var self = TMP_29.$$s || this, $a, $b;
if (cell_pos == null) cell_pos = nil;if (cell == null) cell = nil;
      (($a = [self.$rand($range(1, $scope.get('FLOOR_IMAGE_CHOICES'), false))]), $b = cell, $b['$image_frame='].apply($b, $a), $a[$a.length-1]);
        ...
        return (($a = [$scope.get('ORIENTATION_ROTATIONS').$fetch(cell.$orientation())]), $b = cell.$sprite(), $b['$rotation='].apply($b, $a), $a[$a.length-1]);}, TMP_29.$$s = self, TMP_29), $a).call($c);
      all_entities = self.state.$entities()['$+']([self.state.$player(), self.state.$goal()]);
      ($a = ($d = all_entities).$each, $a.$$p = (TMP_30 = function(e){var self = TMP_30.$$s || this, $a, $b;
if (e == null) e = nil;
      (($a = [self.$game().$add_sprite(e.$image_key())]), $b = e, $b['$sprite='].apply($b, $a), $a[$a.length-1]);
        ...
        return e.$sprite().$play_animation("default");}, TMP_30.$$s = self, TMP_30), $a).call($d);
      ($a = ($e = ($f = ($g = all_entities).$sort_by, $f.$$p = (TMP_32 = function(e){var self = TMP_32.$$s || this, $a;
if (e == null) e = nil;
      return ((($a = $scope.get('ENTITY_SORT_ORDER').$index(e.$image_key())) !== false && $a !== nil) ? $a : $scope.get('ENTITY_SORT_ORDER').$size())}, TMP_32.$$s = self, TMP_32), $f).call($g).$reverse()).$each, $a.$$p = (TMP_31 = function(e){var self = TMP_31.$$s || this;
if (e == null) e = nil;
      return e.$sprite().$bring_to_top()}, TMP_31.$$s = self, TMP_31), $a).call($e);
    ...
    def.$move_player = function(direction) {
      ...
      idx = -1;
      while (((idx = idx['$+'](1)))['$<'](self.state.$entities().$size())) {
...
if (entity == null) entity = nil;
      (($a = [self.$game().$add_sprite(entity.$image_key())]), $b = entity, $b['$sprite='].apply($b, $a), $a[$a.length-1]);
...
if (e == null) e = nil;
      if ((($a = e.$alive()) !== nil && (!$a.$$is_boolean || $a == true))) {
        ...
        return e.$alive();}, TMP_41.$$s = self, TMP_41), $a).call($f);
    };
