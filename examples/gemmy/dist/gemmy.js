...
Opal.modules["gremlin/state"] = function(Opal) {
  ...
  Opal.add_stubs(['$each', '$private', '$key_down', '$normalize_asset_manifest', '$assets', '$destroy!', '$add_text', '$set!', '$position', '$scale', '$*', '$flat_map', '$normalize_asset', '$[]', '$map', '$rjust', '$to_s', '$+', '$times', '$is_a?', '$size', '$===', '$first', '$last', '$include?', '$item', '$fail', '$inspect', '$to_n']);
  return (function($base) {
    var self = $module($base, 'Gremlin');
...
if (type == null) type = nil;if (key == null) key = nil;if (url == null) url = nil;
      ...
      def.$load_update = function() {
        ...
        if ((($a = self._loading_text) !== nil && (!$a.$$is_boolean || $a == true))) {
          ...
          self._loading_text.$position()['$set!'](15, 15);
        ...
        return self._loading_bar.$scale()['$set!'](progress['$*'](self.game.width), 1);
      };
...
if (k == null) k = nil;if (v == null) v = nil;
  ...
  return (function($base, $super) {
    ...
    def['$vadd!'] = function(vec) {
      ...
      ($a = ($b = ($range(0, vec.$size(), true))).$each, $a.$$p = (TMP_11 = function(idx){var self = TMP_11.$$s || this;
if (idx == null) idx = nil;
      return self['$[]='](idx, self['$[]'](idx)['$+'](vec['$[]'](idx)))}, TMP_11.$$s = self, TMP_11), $a).call($b);
      return self;
    };
    ...
    def['$vmul!'] = function(scalar) {
      ...
      ($a = ($b = self)['$map!'], $a.$$p = (TMP_12 = function(val){var self = TMP_12.$$s || this;
if (val == null) val = nil;
      return scalar['$*'](val)}, TMP_12.$$s = self, TMP_12), $a).call($b);
      return self;
    };
    ...
    def['$vset!'] = function(vec) {
      ...
      ($a = ($b = ($range(0, vec.$size(), true))).$each, $a.$$p = (TMP_13 = function(idx){var self = TMP_13.$$s || this;
if (idx == null) idx = nil;
      return self['$[]='](idx, vec['$[]'](idx))}, TMP_13.$$s = self, TMP_13), $a).call($b);
      return self;
    };
