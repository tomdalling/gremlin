...
(function(Opal) {
  ...
  (function($base, $super) {
    ...
    return (def.$button_up = function(button) {
      var self = this;
  ...
  (function($base, $super) {
    ...
    def.$key_down = function(button) {
      ...
      return self.scene.$button_down(button)}, TMP_1.$$s = self, TMP_1), $a).call($b);
    };
    ...
    def.$key_up = function(button) {
      ...
      return self.scene.$button_up(button)}, TMP_2.$$s = self, TMP_2), $a).call($b);
    };
    ...
    def.$update = function() {
      ...
      return self.scene.$update()}, TMP_3.$$s = self, TMP_3), $a).call($b);
    };
    ...
    def.$maybe_transition = TMP_4 = function() {
      var $yielded, self = this, $iter = TMP_4.$$p, $yield = $iter || nil;
  ...
  (function($base) {
    ...
    Opal.defs(self, '$new', TMP_5 = function() {
      var $a, $b, TMP_6, self = this, $iter = TMP_5.$$p, defaults_block = $iter || nil, defaults = nil, klass = nil;

      TMP_5.$$p = null;
      defaults = defaults_block.$call();
      klass = ($a = ($b = $scope.get('Struct')).$new, $a.$$p = (TMP_6 = function(){var self = TMP_6.$$s || this, TMP_8;

      Opal.defn(self, '$initialize', function(attrs) {
          var $a, $b, TMP_7, self = this, defaults = nil;

          if (attrs == null) {
            attrs = $hash2([], {})
          }
          defaults = self.$class().$const_get("DEFAULTS_BLOCK").$call();
          return ($a = ($b = defaults['$merge!'](attrs)).$each, $a.$$p = (TMP_7 = function(k, v){var self = TMP_7.$$s || this;
if (k == null) k = nil;if (v == null) v = nil;
          return self['$[]='](k, v)}, TMP_7.$$s = self, TMP_7), $a).call($b);
        });
        return (Opal.defs(self, '$reopen', TMP_8 = function() {
          var $a, $b, self = this, $iter = TMP_8.$$p, block = $iter || nil;

          TMP_8.$$p = null;
          ($a = ($b = self).$class_exec, $a.$$p = block.$to_proc(), $a).call($b);
          return self;
        }), nil) && 'reopen';}, TMP_6.$$s = self, TMP_6), $a).apply($b, [].concat(defaults.$keys()));
      klass.$const_set("DEFAULTS_BLOCK", defaults_block);
      return klass;
    })
  })(self);
  Opal.cdecl($scope, 'Animation', ($a = ($b = $scope.get('DefStruct')).$new, $a.$$p = (TMP_9 = function(){var self = TMP_9.$$s || this;

  return $hash2(["image_key", "current_frame", "secs_per_frame", "secs_elapsed_this_frame"], {"image_key": nil, "current_frame": 0, "secs_per_frame": 0.3, "secs_elapsed_this_frame": 0})}, TMP_9.$$s = self, TMP_9), $a).call($b));
  Opal.cdecl($scope, 'Entity', ($a = ($c = $scope.get('DefStruct')).$new, $a.$$p = (TMP_10 = function(){var self = TMP_10.$$s || this;

  return $hash2(["sprite", "sort_order", "pos", "pos_fraction", "ai", "color", "tint", "image_key", "image_frame", "animation", "alive", "orientation", "pushable", "teleport_pair", "just_teleported", "deadly"], {"sprite": nil, "sort_order": 0, "pos": $scope.get('Vec2')['$[]'](0, 0), "pos_fraction": $scope.get('Vec2')['$[]'](0, 0), "ai": nil, "color": "white", "tint": "white", "image_key": nil, "image_frame": 0, "animation": nil, "alive": true, "orientation": "north", "pushable": false, "teleport_pair": nil, "just_teleported": false, "deadly": true})}, TMP_10.$$s = self, TMP_10), $a).call($c));
  Opal.cdecl($scope, 'Movement', ($a = ($d = $scope.get('DefStruct')).$new, $a.$$p = (TMP_11 = function(){var self = TMP_11.$$s || this;

  return $hash2(["entity", "from"], {"entity": nil, "from": $scope.get('Vec2')['$[]'](0, 0)})}, TMP_11.$$s = self, TMP_11), $a).call($d));
  Opal.cdecl($scope, 'MovementSet', ($a = ($e = $scope.get('DefStruct')).$new, $a.$$p = (TMP_12 = function(){var self = TMP_12.$$s || this;

  return $hash2(["movements", "progress"], {"movements": [], "progress": 0.0})}, TMP_12.$$s = self, TMP_12), $a).call($e));
  Opal.cdecl($scope, 'GameState', ($a = ($f = $scope.get('DefStruct')).$new, $a.$$p = (TMP_13 = function(){var self = TMP_13.$$s || this;

  return $hash2(["level", "player", "goal", "entities", "movement_sets"], {"level": nil, "player": nil, "goal": nil, "entities": [], "movement_sets": []})}, TMP_13.$$s = self, TMP_13), $a).call($f));
  Opal.cdecl($scope, 'AiResults', ($a = ($g = $scope.get('DefStruct')).$new, $a.$$p = (TMP_14 = function(){var self = TMP_14.$$s || this;

  return $hash2(["moves", "spawns", "kills"], {"moves": [], "spawns": [], "kills": []})}, TMP_14.$$s = self, TMP_14), $a).call($g));
  Opal.cdecl($scope, 'Cell', ($a = ($h = $scope.get('DefStruct')).$new, $a.$$p = (TMP_15 = function(){var self = TMP_15.$$s || this;

  return $hash2(["type", "image_frame", "orientation", "sprite"], {"type": "none", "image_frame": 0, "orientation": "north", "sprite": nil})}, TMP_15.$$s = self, TMP_15), $a).call($h));
  Opal.cdecl($scope, 'Level', ($a = ($i = ($j = ($k = $scope.get('DefStruct')).$new, $j.$$p = (TMP_22 = function(){var self = TMP_22.$$s || this;

  return $hash2(["rows", "entities"], {"rows": [], "entities": []})}, TMP_22.$$s = self, TMP_22), $j).call($k)).$reopen, $a.$$p = (TMP_16 = function(){var self = TMP_16.$$s || this, TMP_21;

  Opal.defs(self, '$from_text', function(file_string) {
      var $a, $b, TMP_17, self = this, rows = nil;

      rows = ($a = ($b = file_string.$lines()).$map, $a.$$p = (TMP_17 = function(line){var self = TMP_17.$$s || this, $a, $b, TMP_18;
if (line == null) line = nil;
      return ($a = ($b = line.$chomp("\n").$each_char()).$map, $a.$$p = (TMP_18 = function(char$){var self = TMP_18.$$s || this;
if (char$ == null) char$ = nil;
        return $scope.get('Cell').$new($hash2(["type"], {"type": $scope.get('CELL_TYPES_BY_CHAR').$fetch(char$)}))}, TMP_18.$$s = self, TMP_18), $a).call($b)}, TMP_17.$$s = self, TMP_17), $a).call($b);
      return self.$new($hash2(["rows"], {"rows": rows}));
    });
    Opal.defn(self, '$each_cell', TMP_21 = function() {
      var $a, $b, TMP_19, self = this, $iter = TMP_21.$$p, $yield = $iter || nil;

      TMP_21.$$p = null;
      return ($a = ($b = self.$rows()).$each_with_index, $a.$$p = (TMP_19 = function(row, row_idx){var self = TMP_19.$$s || this, $a, $b, TMP_20;
if (row == null) row = nil;if (row_idx == null) row_idx = nil;
      return ($a = ($b = row).$each_with_index, $a.$$p = (TMP_20 = function(cell, col_idx){var self = TMP_20.$$s || this, $a;
if (cell == null) cell = nil;if (col_idx == null) col_idx = nil;
        return $a = Opal.yieldX($yield, [$scope.get('Vec2')['$[]'](col_idx, row_idx), cell]), $a === $breaker ? $a : $a}, TMP_20.$$s = self, TMP_20), $a).call($b)}, TMP_19.$$s = self, TMP_19), $a).call($b);
    });
    ...
    }), nil) && 'can_move_to?';}, TMP_16.$$s = self, TMP_16), $a).call($i));
  ...
  (function($base, $super) {
    ...
    return (def.$think = function(projectile, game) {
      var $a, $b, $c, TMP_23, self = this, new_pos = nil, kills = nil;

      new_pos = projectile.$pos()['$+'](self.velocity);
      if ((($a = ($b = game.$level())['$can_move_to?'].apply($b, [].concat(new_pos.$to_a()))) !== nil && (!$a.$$is_boolean || $a == true))) {
        kills = ($a = ($c = game.$entities()).$select, $a.$$p = (TMP_23 = function(e){var self = TMP_23.$$s || this;
if (e == null) e = nil;
        return e.$pos()['$=='](new_pos)}, TMP_23.$$s = self, TMP_23), $a).call($c);
        if (kills.$size()['$>'](0)) {
          kills['$<<'](projectile)};
  ...
  (function($base, $super) {
    ...
    def.$startup = function() {
      var $a, $b, TMP_24, $c, TMP_25, $d, TMP_26, $e, TMP_27, $f, $g, self = this, level_text = nil, all_entities = nil;
      ...
      ($a = ($b = self.state.$level()).$each_cell, $a.$$p = (TMP_24 = function(pos, cell){var self = TMP_24.$$s || this, $a, $b, $case = nil;
...
if (pos == null) pos = nil;if (cell == null) cell = nil;
      return (function() {$case = cell.$type();if ("player"['$===']($case)) {(($a = [$scope.get('Entity').$new($hash2(["pos", "animation", "sort_order"], {"pos": pos.$dup(), "animation": $scope.get('Animation').$new($hash2(["image_key"], {"image_key": "player"})), "sort_order": self.$so("player")}))]), $b = self.state, $b['$player='].apply($b, $a), $a[$a.length-1]);
        ...
        return (($a = ["floor"]), $b = cell, $b['$type='].apply($b, $a), $a[$a.length-1]);}else { return nil }})()}, TMP_24.$$s = self, TMP_24), $a).call($b);
      ($a = ($c = self.state.$level()).$each_cell, $a.$$p = (TMP_25 = function(cell_pos, cell){var self = TMP_25.$$s || this, $a, $b, num_frames = nil;
...
if (e == null) e = nil;
    ...
    def.$apply_ai = function(entity, ai_results, move_set) {
      var $a, $b, TMP_28, $c, TMP_29, $d, TMP_30, self = this;

      ($a = ($b = ai_results.$moves()).$each, $a.$$p = (TMP_28 = function(move){var self = TMP_28.$$s || this, $a;
if (move == null) move = nil;
      ...
      ($a = ($c = ai_results.$spawns()).$each, $a.$$p = (TMP_29 = function(entity){var self = TMP_29.$$s || this, $a, $b;
        if (self.state == null) self.state = nil;
...
if (entity == null) entity = nil;
      return (($a = [false]), $b = entity, $b['$alive='].apply($b, $a), $a[$a.length-1])}, TMP_30.$$s = self, TMP_30), $a).call($d);
    };

    def.$try_move = function(entity, dx, dy, move_set) {
      var $a, $b, TMP_31, $c, self = this, x = nil, y = nil, existing = nil;
      ...
      if ((($a = self.state.$level()['$can_move_to?'](x, y)) !== nil && (!$a.$$is_boolean || $a == true))) {
        existing = ($a = ($b = self.state.$entities()).$find, $a.$$p = (TMP_31 = function(e){var self = TMP_31.$$s || this, $a;
if (e == null) e = nil;
        return ($a = e.$pushable(), $a !== false && $a !== nil ?e.$pos()['$eeql?'](x, y) : $a)}, TMP_31.$$s = self, TMP_31), $a).call($b);
    ...
    def.$update = function() {
      var $a, $b, TMP_32, $c, TMP_33, $d, $e, TMP_34, TMP_35, $f, TMP_36, $g, TMP_37, self = this, did_move = nil, teleporter = nil, other_teleporter = nil;

      self.$update_animation(self.state.$player());
      self.$update_animation(self.state.$goal());
      ($a = ($b = self.state.$entities()).$each, $a.$$p = (TMP_32 = function(entity){var self = TMP_32.$$s || this, $a;
if (entity == null) entity = nil;
      ...
      ($a = ($c = (self.state.$entities()['$+']([self.state.$player()]))).$each, $a.$$p = (TMP_33 = function(e){var self = TMP_33.$$s || this, $a, $b;
if (e == null) e = nil;
      e.$sprite().$position()['$eset!']((e.$pos().$x()['$+'](e.$pos_fraction().$x()))['$*']($scope.get('GRID_SIZE'))['$+']($scope.get('GRID_SIZE')['$/'](2)), (e.$pos().$y()['$+'](e.$pos_fraction().$y()))['$*']($scope.get('GRID_SIZE'))['$+']($scope.get('GRID_SIZE')['$/'](2)));
        return (($a = [$scope.get('ORIENTATION_ROTATIONS').$fetch(e.$orientation())]), $b = e.$sprite(), $b['$rotation='].apply($b, $a), $a[$a.length-1]);}, TMP_33.$$s = self, TMP_33), $a).call($c);
      if (did_move !== false && did_move !== nil) {
        return nil};
      ...
      } else if ((($a = ($d = ($e = self.state.$entities())['$any?'], $d.$$p = (TMP_34 = function(e){var self = TMP_34.$$s || this, $a;
        if (self.state == null) self.state = nil;
if (e == null) e = nil;
      return ($a = e.$deadly(), $a !== false && $a !== nil ?e.$pos()['$=='](self.state.$player().$pos()) : $a)}, TMP_34.$$s = self, TMP_34), $d).call($e)) !== nil && (!$a.$$is_boolean || $a == true))) {
        self.$game().$play_sound("lose");
        return $scope.get('EndLevelScene').$new("You lose", "red", "try again", self.level_number);};
      teleporter = ($a = ($d = self.state.$entities()).$find, $a.$$p = (TMP_35 = function(e){var self = TMP_35.$$s || this, $a;
        if (self.state == null) self.state = nil;
if (e == null) e = nil;
      return ($a = e.$teleport_pair(), $a !== false && $a !== nil ?e.$pos()['$=='](self.state.$player().$pos()) : $a)}, TMP_35.$$s = self, TMP_35), $a).call($d);
      if ((($a = (($f = teleporter !== false && teleporter !== nil) ? self.state.$player().$just_teleported()['$!']() : $f)) !== nil && (!$a.$$is_boolean || $a == true))) {
        ...
        other_teleporter = ($a = ($f = self.state.$entities()).$find, $a.$$p = (TMP_36 = function(e){var self = TMP_36.$$s || this, $a;
if (e == null) e = nil;
        return (($a = e.$teleport_pair()['$=='](teleporter.$teleport_pair())) ? e['$=='](teleporter)['$!']() : $a)}, TMP_36.$$s = self, TMP_36), $a).call($f);
        (($a = [other_teleporter.$pos().$dup()]), $g = self.state.$player(), $g['$pos='].apply($g, $a), $a[$a.length-1]);};
      return ($a = ($g = self.state.$entities())['$select!'], $a.$$p = (TMP_37 = function(e){var self = TMP_37.$$s || this, $a;
if (e == null) e = nil;
    ...
    return (def.$update_next_movement = function() {
      var $a, $b, TMP_38, self = this, move_set = nil;
      ...
      if (move_set !== false && move_set !== nil) {
        ...
        ($a = ($b = move_set.$movements()).$each, $a.$$p = (TMP_38 = function(m){var self = TMP_38.$$s || this, fraction = nil;
if (m == null) m = nil;
        fraction = m.$from().$lerp_to($scope.get('Vec2')['$[]'](0, 0), move_set.$progress());
          return m.$entity().$pos_fraction()['$set!'](fraction);}, TMP_38.$$s = self, TMP_38), $a).call($b);
  ...
  (function($base, $super) {
    ...
    return (def.$startup = function() {
      ...
      bot = self.$game().$add_text("Press space to " + (self.action_text), $hash2(["fill"], {"fill": self.color}));
