...
Opal.modules["gremlin/asset_pack"] = function(Opal) {
  ...
  Opal.add_stubs(['$extend', '$to_n', '$flat_map', '$map', '$Array', '$fetch', '$merge!', '$send', '$+', '$[]', '$raise']);
  return (function($base) {
    var self = $module($base, 'Gremlin');
    ...
    (function($base) {
      var self = $module($base, 'AssetPack');

      var def = self.$$proto, $scope = self.$$scope;

      self.$extend(self);

      Opal.defn(self, '$from_manifest', function(asset_manifest) {
        var $a, $b, TMP_1, self = this;

        return $hash2(["meta", "assets"], {"meta": $hash2(["generated", "version", "app", "url"], {"generated": Date.now(), "version": "1.0", "app": "Gremlin", "url": "https://github.com/tomdalling/gremlin"}), "assets": ($a = ($b = asset_manifest).$flat_map, $a.$$p = (TMP_1 = function(type, asset_list){var self = TMP_1.$$s || this, $a, $b, TMP_2;
...
if (asset == null) asset = nil;
      ...
      Opal.defn(self, '$audio_options', function(key, opts) {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      def.$phaser_preload = function() {
        var self = this, pack = nil;

        pack = (($scope.get('Gremlin')).$$scope.get('AssetPack')).$from_manifest(self.$assets());
        return self.load.pack("assets", null, pack);
      };
