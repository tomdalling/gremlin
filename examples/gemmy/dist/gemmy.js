  ...
  (function($base, $super) {
    ...
    return (def.$think = function(shooter, game) {
      ...
      if (projectile_vel !== false && projectile_vel !== nil) {
        ...
        self.projectile = $scope.get('Entity').$new($hash2(["pos", "ai", "animation"], {"pos": shooter.$pos().$dup(), "ai": $scope.get('ProjectileAi').$new(projectile_vel), "animation": $scope.get('Animation').$new($hash2(["key_prefix"], {"key_prefix": "bullet"}))}));
