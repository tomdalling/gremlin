...
Opal.modules["gremlin/state"] = function(Opal) {
  ...
  Opal.add_stubs(['$each', '$private', '$key_down', '$normalize_asset_manifest', '$assets', '$flat_map', '$normalize_asset', '$[]', '$map', '$rjust', '$to_s', '$+', '$times', '$is_a?', '$size', '$===', '$first', '$last', '$include?', '$item', '$fail', '$inspect', '$to_n']);
  return (function($base) {
    var self = $module($base, 'Gremlin');
