...
Opal.modules["gremlin/vec2"] = function(Opal) {
  ...
  Opal.add_stubs(['$attr_accessor', '$x=', '$y=', '$x', '$y', '$+', '$*', '$[]', '$==', '$^', '$hash', '$new', '$class', '$lerp', '$size', '$raise', '$<=', '$>=']);
  return (function($base) {
    var self = $module($base, 'Gremlin');
...
/* Generated by Opal 0.7.1 */
Opal.modules["gremlin/state"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  ...
  Opal.add_stubs(['$each', '$private', '$key_down', '$normalize_asset_manifest', '$assets', '$destroy!', '$add_text', '$eset!', '$position', '$scale', '$*', '$flat_map', '$normalize_asset', '$[]', '$map', '$rjust', '$to_s', '$+', '$times', '$is_a?', '$size', '$===', '$first', '$last', '$include?', '$item', '$fail', '$inspect', '$to_n']);
  return (function($base) {
    var self = $module($base, 'Gremlin');
    ...
    (function($base, $super) {
      ...
      def.$initialize = function() {
        ...
        return ($a = ($b = $scope.get('PATCHED_METHODS')).$each, $a.$$p = (TMP_1 = function(opal_key, js_key){var self = TMP_1.$$s || this;
if (opal_key == null) opal_key = nil;if (js_key == null) js_key = nil;
        return self[js_key] = self["$" + opal_key];}, TMP_1.$$s = self, TMP_1), $a).call($b);
      };
      ...
      def.$init = function() {
        ...
        return self.input.keyboard.addCallbacks(self, self['$_handle_key_down']);
      };
      ...
      def.$preload = function() {
        ...
        return ($a = ($b = self.$normalize_asset_manifest(self.$assets())).$each, $a.$$p = (TMP_2 = function(type, key, url){var self = TMP_2.$$s || this;
if (type == null) type = nil;if (key == null) key = nil;if (url == null) url = nil;
        return self.load[type](key, url);}, TMP_2.$$s = self, TMP_2), $a).call($b);
      };
      ...
      def.$create = function() {
        ...
        if ((($a = self._loading_bar) !== nil && (!$a.$$is_boolean || $a == true))) {
          return self._loading_bar['$destroy!']()
          } else {
          return nil
        };
      };

      def.$load_update = function() {
      ...
      Opal.cdecl($scope, 'DEFAULT_EXTENSIONS', $hash2(["image", "text", "audio"], {"image": "png", "text": "txt", "audio": "wav"}));
...
if (idx == null) idx = nil;
      ...
      return Opal.cdecl($scope, 'PATCHED_METHODS', $hash2(["init", "preload", "load_render", "load_update", "create", "update", "render", "paused", "pause_update", "resize", "shutdown"], {"init": "init", "preload": "preload", "load_render": "loadRender", "load_update": "loadUpdate", "create": "create", "update": "update", "render": "render", "paused": "paused", "pause_update": "pauseUpdate", "resize": "resize", "shutdown": "shutdown"}));
    })(self, Phaser.State)
  })(self)
};
...
Opal.modules["gremlin/game"] = function(Opal) {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      return (Opal.defs(self, '$new', function(options) {
        var $a, self = this, width = nil, height = nil, renderer = nil, parent = nil, state = nil, transparent = nil, antialias = nil, physics_config = nil;

        if (options == null) {
          options = $hash2([], {})
        }
        $a = Opal.to_ary(options.$fetch("size", [undefined, undefined])), width = ($a[0] == null ? nil : $a[0]), height = ($a[1] == null ? nil : $a[1]);
        renderer = $scope.get('RENDERERS').$fetch(options.$fetch("renderer", "auto"));
        parent = ((($a = options['$[]']("parent")) !== false && $a !== nil) ? $a : undefined);
        state = ((($a = options['$[]']("state")) !== false && $a !== nil) ? $a : undefined);
...
/* Generated by Opal 0.7.1 */
Opal.modules["naghavi"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $klass = Opal.klass;

  Opal.add_stubs(['$require', '$attr_accessor', '$transition_to_scene', '$maybe_transition', '$button_down', '$button_up', '$update', '$draw', '$private', '$!', '$native?', '$is_a?', '$window=', '$shutdown', '$startup']);
  self.$require("gremlin");
  return (function($base) {
    var self = $module($base, 'Naghavi');
    ...
    (function($base, $super) {
      ...
      self.$attr_accessor("window");

      Opal.defn(self, '$w', def.$window);
      ...
      def.$button_up = function(button) {
        var self = this;

        return nil;
      };

      def['$needs_redraw?'] = function() {
        var self = this;

        return true;
      };

      return (def['$needs_cursor?'] = function() {
        var self = this;
    ...
    (function($base, $super) {
      ...
      var def = self.$$proto, $scope = self.$$scope, TMP_1, TMP_2, TMP_6;

      def.assets = def.initial_scene = def.scene = nil;
      def.$initialize = TMP_1 = function(scene, assets) {
        var self = this, $iter = TMP_1.$$p, $yield = $iter || nil;
      ...
      def.$create = TMP_2 = function() {var $zuper = $slice.call(arguments, 0);
        var self = this, $iter = TMP_2.$$p, $yield = $iter || nil;

        TMP_2.$$p = null;
        Opal.find_super_dispatcher(self, 'create', TMP_2, $iter).apply(self, $zuper);
        return self.$transition_to_scene(self.initial_scene);
      };

      def.$key_down = function(button) {
        var $a, $b, TMP_3, self = this;

        return ($a = ($b = self).$maybe_transition, $a.$$p = (TMP_3 = function(){var self = TMP_3.$$s || this;
          if (self.scene == null) self.scene = nil;

        return self.scene.$button_down(button)}, TMP_3.$$s = self, TMP_3), $a).call($b);
      };

      def.$key_up = function(button) {
        var $a, $b, TMP_4, self = this;

        return ($a = ($b = self).$maybe_transition, $a.$$p = (TMP_4 = function(){var self = TMP_4.$$s || this;
          if (self.scene == null) self.scene = nil;

        return self.scene.$button_up(button)}, TMP_4.$$s = self, TMP_4), $a).call($b);
      };
      ...
      return (def.$transition_to_scene = function(scene) {
        ...
        if ((($b = self.scene) !== nil && (!$b.$$is_boolean || $b == true))) {
          (($b = [nil]), $c = self.scene, $c['$window='].apply($c, $b), $b[$b.length-1]);
          self.scene.$shutdown();};
        self.game.world.shutdown();
        self.scene = scene;
        (($b = [self]), $c = self.scene, $c['$window='].apply($c, $b), $b[$b.length-1]);
        scene = self.scene.$startup();};
      }, nil) && 'transition_to_scene';
    })(self, (($scope.get('Gremlin')).$$scope.get('State')));
  })(self);
};
...
(function(Opal) {
  Opal.dynamic_require_severity = "error";
  var $a, $b, TMP_5, $c, TMP_6, $d, TMP_7, $e, TMP_8, $f, TMP_9, $g, TMP_10, $h, TMP_11, $i, TMP_12, $j, $k, TMP_18, self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $hash2 = Opal.hash2, $module = Opal.module, $klass = Opal.klass, $range = Opal.range, starting_scene = nil, nag_window = nil, game = nil;

  Opal.add_stubs(['$require', '$include', '$/', '$*', '$call', '$new', '$const_get', '$class', '$each', '$[]=', '$merge!', '$class_exec', '$to_proc', '$keys', '$const_set', '$[]', '$reopen', '$map', '$fetch', '$each_char', '$chomp', '$lines', '$each_with_index', '$rows', '$size', '$first', '$cell_at', '$==', '$type', '$>', '$<', '$pos', '$player', '$distance_to', '$x', '$<<', '$y', '$!', '$alive', '$orientation=', '$orientation_for_movement', '$dup', '$+', '$can_move_to?', '$level', '$to_a', '$select', '$entities', '$index', '$play_sound', '$w', '$get_text', '$from_text', '$entities=', '$each_cell', '$===', '$player=', '$so', '$type=', '$goal=', '$image_frame=', '$rand', '$sample', '$sprite=', '$add_sprite', '$to_s', '$image_frame', '$eset!', '$position', '$sprite', '$pivot', '$width', '$height', '$scale', '$rotation=', '$orientation', '$goal', '$image_key', '$animation', '$current_frame', '$bring_to_top', '$reverse', '$sort_by', '$add_text', '$movement_sets', '$move_player', '$next_level', '$%', '$try_move', '$just_teleported=', '$ai', '$think', '$apply_ai', '$movements', '$moves', '$spawns', '$alive=', '$kills', '$>=', '$row_count', '$column_count', '$find', '$pushable', '$eeql?', '$-@', '$update_animation', '$update_next_movement', '$secs_per_frame=', '$pos_fraction', '$any?', '$deadly', '$teleport_pair', '$just_teleported', '$pos=', '$select!', '$destroy!', '$secs_elapsed_this_frame=', '$secs_elapsed_this_frame', '$delta_time', '$secs_per_frame', '$-', '$current_frame=', '$image_key=', '$<=', '$progress', '$progress=', '$lerp_to', '$from', '$set!', '$entity', '$shift', '$game_size']);
  ...
  (function($base) {
    ...
    Opal.defs(self, '$new', TMP_1 = function() {
      var $a, $b, TMP_2, self = this, $iter = TMP_1.$$p, defaults_block = $iter || nil, defaults = nil, klass = nil;

      TMP_1.$$p = null;
      defaults = defaults_block.$call();
      klass = ($a = ($b = $scope.get('Struct')).$new, $a.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this, TMP_4;

      Opal.defn(self, '$initialize', function(attrs) {
          var $a, $b, TMP_3, self = this, defaults = nil;

          if (attrs == null) {
            attrs = $hash2([], {})
          }
          defaults = self.$class().$const_get("DEFAULTS_BLOCK").$call();
          return ($a = ($b = defaults['$merge!'](attrs)).$each, $a.$$p = (TMP_3 = function(k, v){var self = TMP_3.$$s || this;
if (k == null) k = nil;if (v == null) v = nil;
          return self['$[]='](k, v)}, TMP_3.$$s = self, TMP_3), $a).call($b);
        });
        return (Opal.defs(self, '$reopen', TMP_4 = function() {
          var $a, $b, self = this, $iter = TMP_4.$$p, block = $iter || nil;

          TMP_4.$$p = null;
          ($a = ($b = self).$class_exec, $a.$$p = block.$to_proc(), $a).call($b);
          return self;
        }), nil) && 'reopen';}, TMP_2.$$s = self, TMP_2), $a).apply($b, [].concat(defaults.$keys()));
      klass.$const_set("DEFAULTS_BLOCK", defaults_block);
      return klass;
    })
  })(self);
  Opal.cdecl($scope, 'Animation', ($a = ($b = $scope.get('DefStruct')).$new, $a.$$p = (TMP_5 = function(){var self = TMP_5.$$s || this;

  return $hash2(["image_key", "current_frame", "secs_per_frame", "secs_elapsed_this_frame"], {"image_key": nil, "current_frame": 0, "secs_per_frame": 0.3, "secs_elapsed_this_frame": 0})}, TMP_5.$$s = self, TMP_5), $a).call($b));
  Opal.cdecl($scope, 'Entity', ($a = ($c = $scope.get('DefStruct')).$new, $a.$$p = (TMP_6 = function(){var self = TMP_6.$$s || this;

  return $hash2(["sprite", "sort_order", "pos", "pos_fraction", "ai", "color", "tint", "image_key", "image_frame", "animation", "alive", "orientation", "pushable", "teleport_pair", "just_teleported", "deadly"], {"sprite": nil, "sort_order": 0, "pos": $scope.get('Vec2')['$[]'](0, 0), "pos_fraction": $scope.get('Vec2')['$[]'](0, 0), "ai": nil, "color": "white", "tint": "white", "image_key": nil, "image_frame": 0, "animation": nil, "alive": true, "orientation": "north", "pushable": false, "teleport_pair": nil, "just_teleported": false, "deadly": true})}, TMP_6.$$s = self, TMP_6), $a).call($c));
  Opal.cdecl($scope, 'Movement', ($a = ($d = $scope.get('DefStruct')).$new, $a.$$p = (TMP_7 = function(){var self = TMP_7.$$s || this;

  return $hash2(["entity", "from"], {"entity": nil, "from": $scope.get('Vec2')['$[]'](0, 0)})}, TMP_7.$$s = self, TMP_7), $a).call($d));
  Opal.cdecl($scope, 'MovementSet', ($a = ($e = $scope.get('DefStruct')).$new, $a.$$p = (TMP_8 = function(){var self = TMP_8.$$s || this;

  return $hash2(["movements", "progress"], {"movements": [], "progress": 0.0})}, TMP_8.$$s = self, TMP_8), $a).call($e));
  Opal.cdecl($scope, 'GameState', ($a = ($f = $scope.get('DefStruct')).$new, $a.$$p = (TMP_9 = function(){var self = TMP_9.$$s || this;

  return $hash2(["level", "player", "goal", "entities", "movement_sets"], {"level": nil, "player": nil, "goal": nil, "entities": [], "movement_sets": []})}, TMP_9.$$s = self, TMP_9), $a).call($f));
  Opal.cdecl($scope, 'AiResults', ($a = ($g = $scope.get('DefStruct')).$new, $a.$$p = (TMP_10 = function(){var self = TMP_10.$$s || this;

  return $hash2(["moves", "spawns", "kills"], {"moves": [], "spawns": [], "kills": []})}, TMP_10.$$s = self, TMP_10), $a).call($g));
  Opal.cdecl($scope, 'Cell', ($a = ($h = $scope.get('DefStruct')).$new, $a.$$p = (TMP_11 = function(){var self = TMP_11.$$s || this;

  return $hash2(["type", "image_frame", "orientation", "sprite"], {"type": "none", "image_frame": 0, "orientation": "north", "sprite": nil})}, TMP_11.$$s = self, TMP_11), $a).call($h));
  Opal.cdecl($scope, 'Level', ($a = ($i = ($j = ($k = $scope.get('DefStruct')).$new, $j.$$p = (TMP_18 = function(){var self = TMP_18.$$s || this;

  return $hash2(["rows", "entities"], {"rows": [], "entities": []})}, TMP_18.$$s = self, TMP_18), $j).call($k)).$reopen, $a.$$p = (TMP_12 = function(){var self = TMP_12.$$s || this, TMP_17;

  Opal.defs(self, '$from_text', function(file_string) {
      var $a, $b, TMP_13, self = this, rows = nil;

      rows = ($a = ($b = file_string.$lines()).$map, $a.$$p = (TMP_13 = function(line){var self = TMP_13.$$s || this, $a, $b, TMP_14;
if (line == null) line = nil;
      return ($a = ($b = line.$chomp("\n").$each_char()).$map, $a.$$p = (TMP_14 = function(char$){var self = TMP_14.$$s || this;
if (char$ == null) char$ = nil;
        return $scope.get('Cell').$new($hash2(["type"], {"type": $scope.get('CELL_TYPES_BY_CHAR').$fetch(char$)}))}, TMP_14.$$s = self, TMP_14), $a).call($b)}, TMP_13.$$s = self, TMP_13), $a).call($b);
      return self.$new($hash2(["rows"], {"rows": rows}));
    });
    Opal.defn(self, '$each_cell', TMP_17 = function() {
      var $a, $b, TMP_15, self = this, $iter = TMP_17.$$p, $yield = $iter || nil;

      TMP_17.$$p = null;
      return ($a = ($b = self.$rows()).$each_with_index, $a.$$p = (TMP_15 = function(row, row_idx){var self = TMP_15.$$s || this, $a, $b, TMP_16;
if (row == null) row = nil;if (row_idx == null) row_idx = nil;
      return ($a = ($b = row).$each_with_index, $a.$$p = (TMP_16 = function(cell, col_idx){var self = TMP_16.$$s || this, $a;
if (cell == null) cell = nil;if (col_idx == null) col_idx = nil;
        return $a = Opal.yieldX($yield, [$scope.get('Vec2')['$[]'](col_idx, row_idx), cell]), $a === $breaker ? $a : $a}, TMP_16.$$s = self, TMP_16), $a).call($b)}, TMP_15.$$s = self, TMP_15), $a).call($b);
    });
    ...
    }), nil) && 'can_move_to?';}, TMP_12.$$s = self, TMP_12), $a).call($i));
  ...
  (function($base, $super) {
    ...
    return (def.$think = function(projectile, game) {
      var $a, $b, $c, TMP_19, self = this, new_pos = nil, kills = nil;

      new_pos = projectile.$pos()['$+'](self.velocity);
      if ((($a = ($b = game.$level())['$can_move_to?'].apply($b, [].concat(new_pos.$to_a()))) !== nil && (!$a.$$is_boolean || $a == true))) {
        kills = ($a = ($c = game.$entities()).$select, $a.$$p = (TMP_19 = function(e){var self = TMP_19.$$s || this;
if (e == null) e = nil;
        return e.$pos()['$=='](new_pos)}, TMP_19.$$s = self, TMP_19), $a).call($c);
        if (kills.$size()['$>'](0)) {
          kills['$<<'](projectile)};
  ...
  (function($base, $super) {
    ...
    def.level_number = def.game = def.level_number_text = nil;
    ...
    def.$startup = function() {
      var $a, $b, TMP_20, $c, TMP_21, $d, TMP_22, $e, TMP_23, $f, $g, self = this, level_text = nil, all_entities = nil;

      if ((($a = (($b = Opal.cvars['@@song']) == null ? nil : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
        } else {
        (Opal.cvars['@@song'] = self.$w().$play_sound("music", true))
      };
      level_text = self.$w().$get_text("level" + (self.level_number));
      self.game = $scope.get('GameState').$new($hash2(["level"], {"level": $scope.get('Level').$from_text(level_text)}));
      ($a = self.game, ((($b = $a.$entities()) !== false && $b !== nil) ? $b : $a['$entities=']([])));
      ($a = ($b = self.game.$level()).$each_cell, $a.$$p = (TMP_20 = function(pos, cell){var self = TMP_20.$$s || this, $a, $b, $case = nil;
        if (self.game == null) self.game = nil;
if (pos == null) pos = nil;if (cell == null) cell = nil;
      return (function() {$case = cell.$type();if ("player"['$===']($case)) {(($a = [$scope.get('Entity').$new($hash2(["pos", "animation", "sort_order"], {"pos": pos.$dup(), "animation": $scope.get('Animation').$new($hash2(["image_key"], {"image_key": "player"})), "sort_order": self.$so("player")}))]), $b = self.game, $b['$player='].apply($b, $a), $a[$a.length-1]);
        return (($a = ["floor"]), $b = cell, $b['$type='].apply($b, $a), $a[$a.length-1]);}else if ("enemy"['$===']($case)) {self.game.$entities()['$<<']($scope.get('Entity').$new($hash2(["pos", "ai", "animation", "sort_order"], {"pos": pos.$dup(), "ai": $scope.get('ChaserAi').$new(), "animation": $scope.get('Animation').$new($hash2(["image_key"], {"image_key": "chaser"})), "sort_order": self.$so("enemy")})));
        return (($a = ["floor"]), $b = cell, $b['$type='].apply($b, $a), $a[$a.length-1]);}else if ("shooter"['$===']($case)) {self.game.$entities()['$<<']($scope.get('Entity').$new($hash2(["pos", "ai", "animation", "sort_order"], {"pos": pos.$dup(), "ai": $scope.get('ShooterAi').$new(), "animation": $scope.get('Animation').$new($hash2(["image_key"], {"image_key": "shooter"})), "sort_order": self.$so("enemy")})));
        return (($a = ["floor"]), $b = cell, $b['$type='].apply($b, $a), $a[$a.length-1]);}else if ("goal"['$===']($case)) {(($a = [$scope.get('Entity').$new($hash2(["pos", "animation", "sort_order"], {"pos": pos.$dup(), "animation": $scope.get('Animation').$new($hash2(["image_key", "secs_per_frame"], {"image_key": "goal", "secs_per_frame": 0.2})), "sort_order": self.$so("goal")}))]), $b = self.game, $b['$goal='].apply($b, $a), $a[$a.length-1]);
        return (($a = ["floor"]), $b = cell, $b['$type='].apply($b, $a), $a[$a.length-1]);}else if ("dirtball"['$===']($case)) {self.game.$entities()['$<<']($scope.get('Entity').$new($hash2(["pos", "animation", "pushable", "sort_order"], {"pos": pos.$dup(), "animation": $scope.get('Animation').$new($hash2(["image_key"], {"image_key": "dirtball"})), "pushable": true, "sort_order": self.$so("dirtball")})));
        return (($a = ["floor"]), $b = cell, $b['$type='].apply($b, $a), $a[$a.length-1]);}else if ("teleporter"['$===']($case)) {self.game.$entities()['$<<']($scope.get('Entity').$new($hash2(["pos", "animation", "teleport_pair", "deadly", "sort_order"], {"pos": pos.$dup(), "animation": $scope.get('Animation').$new($hash2(["image_key"], {"image_key": "teleporter"})), "teleport_pair": 1, "deadly": false, "sort_order": self.$so("teleporter")})));
        return (($a = ["floor"]), $b = cell, $b['$type='].apply($b, $a), $a[$a.length-1]);}else { return nil }})()}, TMP_20.$$s = self, TMP_20), $a).call($b);
      ($a = ($c = self.game.$level()).$each_cell, $a.$$p = (TMP_21 = function(cell_pos, cell){var self = TMP_21.$$s || this, $a, $b, num_frames = nil;
if (cell_pos == null) cell_pos = nil;if (cell == null) cell = nil;
      num_frames = $scope.get('ANIMATIONS_FRAMES')['$[]'](cell.$type());
        ...
        return cell.$sprite().smoothed = false;}, TMP_21.$$s = self, TMP_21), $a).call($c);
      all_entities = self.game.$entities()['$+']([self.game.$player(), self.game.$goal()]);
      ($a = ($d = all_entities).$each, $a.$$p = (TMP_22 = function(e){var self = TMP_22.$$s || this, $a, $b;
if (e == null) e = nil;
      (($a = [self.$w().$add_sprite(e.$animation().$image_key()['$+'](e.$animation().$current_frame().$to_s()))]), $b = e, $b['$sprite='].apply($b, $a), $a[$a.length-1]);
        ...
        return e.$sprite().smoothed = false;}, TMP_22.$$s = self, TMP_22), $a).call($d);
      ($a = ($e = ($f = ($g = all_entities).$sort_by, $f.$$p = "sort_order".$to_proc(), $f).call($g).$reverse()).$each, $a.$$p = (TMP_23 = function(e){var self = TMP_23.$$s || this;
if (e == null) e = nil;
      return e.$sprite().$bring_to_top()}, TMP_23.$$s = self, TMP_23), $a).call($e);
      self.level_number_text = self.$w().$add_text("Level " + (self.level_number['$+'](1)), $hash2(["fill"], {"fill": "white"}));
      self.level_number_text.$position()['$eset!'](15, 15);
      return self.$w().$play_sound("start");
    };

    def.$button_down = function(button) {
      var self = this, $case = nil;

      if (self.game.$movement_sets().$size()['$=='](0)) {
        return (function() {$case = button;if ($scope.get('KEY_UP')['$===']($case)) {return self.$move_player(0, -1)}else if ($scope.get('KEY_DOWN')['$===']($case)) {return self.$move_player(0, 1)}else if ($scope.get('KEY_LEFT')['$===']($case)) {return self.$move_player(-1, 0)}else if ($scope.get('KEY_RIGHT')['$===']($case)) {return self.$move_player(1, 0)}else if ($scope.get('KEY_SPACEBAR')['$===']($case)) {return self.$move_player(0, 0)}else if ($scope.get('KEY_N')['$===']($case)) {return $scope.get('LevelScene').$new(self.$next_level())}else if ($scope.get('KEY_P')['$===']($case)) {return $scope.get('LevelScene').$new(self.$next_level(-1))}else if ($scope.get('KEY_Z')['$===']($case)) {return $scope.get('LevelScene').$new(self.level_number)}else { return nil }})()
        } else {
        return nil
      };
    };
    ...
    def.$apply_ai = function(entity, ai_results, move_set) {
      var $a, $b, TMP_24, $c, TMP_25, $d, TMP_26, self = this;

      ($a = ($b = ai_results.$moves()).$each, $a.$$p = (TMP_24 = function(move){var self = TMP_24.$$s || this, $a;
if (move == null) move = nil;
      ...
      ($a = ($c = ai_results.$spawns()).$each, $a.$$p = (TMP_25 = function(entity){var self = TMP_25.$$s || this, $a, $b;
        if (self.game == null) self.game = nil;
if (entity == null) entity = nil;
      (($a = [self.$w().$add_sprite(entity.$animation().$image_key()['$+'](entity.$animation().$current_frame().$to_s()))]), $b = entity, $b['$sprite='].apply($b, $a), $a[$a.length-1]);
        ...
        return self.game.$entities()['$<<'](entity);}, TMP_25.$$s = self, TMP_25), $a).call($c);
      return ($a = ($d = ai_results.$kills()).$each, $a.$$p = (TMP_26 = function(entity){var self = TMP_26.$$s || this, $a, $b;
if (entity == null) entity = nil;
      return (($a = [false]), $b = entity, $b['$alive='].apply($b, $a), $a[$a.length-1])}, TMP_26.$$s = self, TMP_26), $a).call($d);
    };

    def.$try_move = function(entity, dx, dy, move_set) {
      var $a, $b, TMP_27, $c, self = this, x = nil, y = nil, existing = nil;

      x = entity.$pos().$x()['$+'](dx);
      y = entity.$pos().$y()['$+'](dy);
      if ((($a = ((($b = y['$<'](0)) !== false && $b !== nil) ? $b : y['$>='](self.game.$level().$row_count()))) !== nil && (!$a.$$is_boolean || $a == true))) {
        return nil};
      ...
      if ((($a = self.game.$level()['$can_move_to?'](x, y)) !== nil && (!$a.$$is_boolean || $a == true))) {
        existing = ($a = ($b = self.game.$entities()).$find, $a.$$p = (TMP_27 = function(e){var self = TMP_27.$$s || this, $a;
if (e == null) e = nil;
        return ($a = e.$pushable(), $a !== false && $a !== nil ?e.$pos()['$eeql?'](x, y) : $a)}, TMP_27.$$s = self, TMP_27), $a).call($b);
    ...
    def.$update = function() {
      var $a, $b, TMP_28, $c, TMP_29, $d, $e, TMP_30, TMP_31, $f, TMP_32, $g, TMP_33, self = this, did_move = nil, teleporter = nil, other_teleporter = nil;

      self.$update_animation(self.game.$player());
      self.$update_animation(self.game.$goal());
      ($a = ($b = self.game.$entities()).$each, $a.$$p = (TMP_28 = function(entity){var self = TMP_28.$$s || this, $a;
if (entity == null) entity = nil;
      ...
      ($a = ($c = (self.game.$entities()['$+']([self.game.$player()]))).$each, $a.$$p = (TMP_29 = function(e){var self = TMP_29.$$s || this, $a, $b;
if (e == null) e = nil;
      e.$sprite().$position()['$eset!']((e.$pos().$x()['$+'](e.$pos_fraction().$x()))['$*']($scope.get('GRID_SIZE'))['$+']($scope.get('GRID_SIZE')['$/'](2)), (e.$pos().$y()['$+'](e.$pos_fraction().$y()))['$*']($scope.get('GRID_SIZE'))['$+']($scope.get('GRID_SIZE')['$/'](2)));
        return (($a = [$scope.get('ORIENTATION_ROTATIONS').$fetch(e.$orientation())]), $b = e.$sprite(), $b['$rotation='].apply($b, $a), $a[$a.length-1]);}, TMP_29.$$s = self, TMP_29), $a).call($c);
      if (did_move !== false && did_move !== nil) {
        return nil};
      ...
      } else if ((($a = ($d = ($e = self.game.$entities())['$any?'], $d.$$p = (TMP_30 = function(e){var self = TMP_30.$$s || this, $a;
        if (self.game == null) self.game = nil;
if (e == null) e = nil;
      return ($a = e.$deadly(), $a !== false && $a !== nil ?e.$pos()['$=='](self.game.$player().$pos()) : $a)}, TMP_30.$$s = self, TMP_30), $d).call($e)) !== nil && (!$a.$$is_boolean || $a == true))) {
        self.$w().$play_sound("lose");
        return $scope.get('EndLevelScene').$new("You lose", "red", "try again", self.level_number);};
      teleporter = ($a = ($d = self.game.$entities()).$find, $a.$$p = (TMP_31 = function(e){var self = TMP_31.$$s || this, $a;
        if (self.game == null) self.game = nil;
if (e == null) e = nil;
      return ($a = e.$teleport_pair(), $a !== false && $a !== nil ?e.$pos()['$=='](self.game.$player().$pos()) : $a)}, TMP_31.$$s = self, TMP_31), $a).call($d);
      if ((($a = (($f = teleporter !== false && teleporter !== nil) ? self.game.$player().$just_teleported()['$!']() : $f)) !== nil && (!$a.$$is_boolean || $a == true))) {
        ...
        other_teleporter = ($a = ($f = self.game.$entities()).$find, $a.$$p = (TMP_32 = function(e){var self = TMP_32.$$s || this, $a;
if (e == null) e = nil;
        return (($a = e.$teleport_pair()['$=='](teleporter.$teleport_pair())) ? e['$=='](teleporter)['$!']() : $a)}, TMP_32.$$s = self, TMP_32), $a).call($f);
        (($a = [other_teleporter.$pos().$dup()]), $g = self.game.$player(), $g['$pos='].apply($g, $a), $a[$a.length-1]);};
      return ($a = ($g = self.game.$entities())['$select!'], $a.$$p = (TMP_33 = function(e){var self = TMP_33.$$s || this, $a;
if (e == null) e = nil;
    ...
    def.$update_animation = function(entity) {
      ...
      ($a = anim, $a['$secs_elapsed_this_frame=']($a.$secs_elapsed_this_frame()['$+'](self.$w().$delta_time())));
    ...
    return (def.$update_next_movement = function() {
      var $a, $b, TMP_34, self = this, move_set = nil;
      ...
      if (move_set !== false && move_set !== nil) {
        ...
        ($a = ($b = move_set.$movements()).$each, $a.$$p = (TMP_34 = function(m){var self = TMP_34.$$s || this, fraction = nil;
if (m == null) m = nil;
        fraction = m.$from().$lerp_to($scope.get('Vec2')['$[]'](0, 0), move_set.$progress());
          return m.$entity().$pos_fraction()['$set!'](fraction);}, TMP_34.$$s = self, TMP_34), $a).call($b);
  ...
  (function($base, $super) {
    ...
    return (def.$startup = function() {
      ...
      screen = self.$w().$game_size();
      top = self.$w().$add_text(self.text, $hash2(["fill"], {"fill": self.color}));
      top.$position()['$eset!'](screen.$x()['$/'](2)['$-'](top.$width()['$/'](2)), screen.$y()['$/'](2));
      bot = self.$w().$add_text("Press space to " + (self.action_text), $hash2(["fill"], {"fill": self.color}));
  ...
  (function($base, $super) {
    ...
    def.$startup = function() {
      ...
      self.background = self.$w().$add_sprite("intro_background");
      return self.$w().stage.smoothed = false;;
    };

    return (def.$button_down = function(button) {
      var self = this;

      return $scope.get('LevelScene').$new(0);
    }, nil) && 'button_down';
  })(self, (($scope.get('Naghavi')).$$scope.get('Scene')));
  Opal.cdecl($scope, 'ASSETS', $hash2(["image", "text", "audio"], {"image": ["intro_background", ["dirtball", 1], ["bullet", 1], ["player", 3], ["chaser", 3], ["wall", 4], ["goal", 3], ["floor", 4], ["shooter", 5], ["teleporter", 4]], "text": [["level", $scope.get('NUM_LEVELS')]], "audio": ["lose", "move", "start", "win", ["music", "mp3"]]}));
  starting_scene = $scope.get('IntroScene').$new();
  nag_window = (($scope.get('Naghavi')).$$scope.get('Window')).$new(starting_scene, $scope.get('ASSETS'));
  game = (($scope.get('Gremlin')).$$scope.get('Game')).$new($hash2(["size", "state"], {"size": [(13)['$*']($scope.get('GRID_SIZE')), (10)['$*']($scope.get('GRID_SIZE'))], "state": nag_window}));
